...
function detectFaces (fileName) {
  ...
  // The local image file on which to perform face detection
...
function detectLabels (fileName) {
  ...
  // The local image file on which to perform label detection
  // fileName = '/path/to/image.jpg';
...
function detectLandmarks (fileName) {
  ...
  // The local image file on which to perform landmark detection
  // fileName = '/path/to/image.jpg';
...
function detectText (fileName) {
  ...
  // The local image file on which to perform text detection
  // fileName = '/path/to/image.jpg';
...
function detectLogos (fileName) {
  ...
  // The local image file on which to perform logo detection
  // fileName = '/path/to/image.jpg';
...
function detectProperties (fileName) {
  ...
  // The local image file on which to perform image property detection
  // fileName = '/path/to/image.jpg';
...
function detectSafeSearch (fileName) {
  ...
  // The local image file on which to perform safe search property detection
  // fileName = '/path/to/image.jpg';
...
require(`yargs`)
  ...
  .example(`node $0 faces /path/to/image.jpg`)
  .example(`node $0 faces-gcs my-bucket image.jpg`)
  .example(`node $0 labels ./resources/cat.jpg`)
  .example(`node $0 labels-gcs my-bucket cat.jpg`)
  .example(`node $0 landmarks ./resources/water.jpg`)
  .example(`node $0 landmarks-gcs my-bucket water.jpg`)
  .example(`node $0 text ./resources/mountain.jpg`)
  .example(`node $0 text-gcs my-bucket mountain.jpg`)
  .example(`node $0 logos ./resources/logo.png`)
  .example(`node $0 logos-gcs my-bucket logo.png`)
  .example(`node $0 properties ./resources/cat.jpg`)
  .example(`node $0 properties-gcs my-bucket cat.jpg`)
  .example(`node $0 safe-search ./resources/cat.jpg`)
  .example(`node $0 safe-search-gcs my-bucket cat.jpg`)
  .wrap(120)
  .recommendCommands()
